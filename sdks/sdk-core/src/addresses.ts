...
const DEFAULT_NETWORKS = [ChainId.ZANJIR, ChainId.ZANJIR_TESTNET]
...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  [ChainId.ZANJIR]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D',
  [ChainId.ZANJIR_TESTNET]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D',
}
/**
...
const ZANJIR_ADDRESSES: ChainAddresses = {
...
const ZANJIR_TESTNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x1F98431c8aD98523631AE4a59f267346ea31F984',
  multicallAddress: '0x1F98415757620B543A52E61c46B32eB19261F984',
  quoterAddress: '0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6',
  v3MigratorAddress: '0xA5644E29708357803b5A882D272c41cC0dF92B34',
...
export const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  [ChainId.ZANJIR]: ZANJIR_ADDRESSES,
  [ChainId.ZANJIR_TESTNET]: ZANJIR_TESTNET_ADDRESSES,
}
...
export const GOVERNANCE_ALPHA_V1_ADDRESSES: AddressMap = {
  [ChainId.ZANJIR]: '0xC4e172459f1E7939D522503B81AFAaC1014CE6F6',
}
/**
 * The latest governor bravo that is currently admin of timelock
 */
export const GOVERNANCE_BRAVO_ADDRESSES: AddressMap = {
  [ChainId.ZANJIR]: '0x408ED6354d4973f66138C91495F2f2FCbd8724C3',
}

export const TIMELOCK_ADDRESSES: AddressMap = constructSameAddressMap('0x1a9C8182C09F50C8318d769245beA52c32BE35BC')

export const MERKLE_DISTRIBUTOR_ADDRESS: AddressMap = {
  [ChainId.ZANJIR]: '0x090D4613473dEE047c3f2706764f49E0821D256e',
}

export const ARGENT_WALLET_DETECTOR_ADDRESS: AddressMap = {
  [ChainId.ZANJIR]: '0xeca4B0bDBf7c55E9b7925919d03CbF8Dc82537E8',
}
...
export const SOCKS_CONTROLLER_ADDRESSES: AddressMap = {
  [ChainId.ZANJIR]: '0x65770b5283117639760beA3F867b69b3697a91dd',
}
